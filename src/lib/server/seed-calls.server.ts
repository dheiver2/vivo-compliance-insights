...
const REAL_CASES: RealCase[] = [
  ...
  },
  {
    ...
    sentiment: "negativo",
    summary:
      "Atendente não informou gravação e consentimento LGPD, além de não confirmar dados cadastrais.",
    checks: [
      {
        label: "Identificação do atendente",
        passed: false,
